...
#
# Intended usage:
#   bash -c "$(curl -fsSL https://.../host/remote/codeberg-install.sh)" -- [install.sh args...]
#
...
usage() {
  printf '%s\n' \
    ...
    "" \
    "Examples:" \
    "  bash -c \"\$(curl -fsSL https://.../host/remote/codeberg-install.sh)\"" \
    "  bash -c \"\$(curl -fsSL https://.../host/remote/codeberg-install.sh)\" -- --dry-run" \
    "" \
