...
import type { ProxmoxContainerStatus, ProxmoxNodesResult } from "../types/proxmoxTypes";
import type {
  AppSnapshot,
  CommandResult,
  FilePreview,
...
interface MountOptions {
  root: HTMLDivElement;
  rpc: ProxnixRpcClient;
}

export function mountProxnixManager({ root, rpc: proxnixRpc }: MountOptions): void {
